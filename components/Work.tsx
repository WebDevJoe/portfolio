...
const projectImage1 = "https://www.figma.com/api/mcp/asset/48cb6f2e-cc55-4976-9e9c-33fbde381b59";
const projectImage2 = "https://www.figma.com/api/mcp/asset/9a641b40-d704-4a70-8a2b-9c6d491170ff";
...
const PROJECTS: Record<Tab, { role: string; title: string; description: string; image: string }[]> = {
  "Game UI/UX": [
    {
...
function ProjectCard({ role, title, description, image }: { role: string; title: string; description: string; image: string }) {
  return (
