...
function SocialButton({ children, href }: { children: React.ReactNode; href: string }) {
  return (
    <a
      ...
      className="w-12 h-12 rounded-full bg-[rgba(49,141,217,0.2)] flex items-center justify-center text-[#252525] hover:bg-[rgba(49,141,217,0.3)] transition-colors"
    >
      {children}
    </a>
  );
...
export default function Footer() {
  return (
    <footer className="w-full border-t border-black/8">
      <div className="max-w-[1440px] mx-auto px-4 md:px-12 xl:px-[64px] py-8 flex flex-col md:flex-row items-center justify-between gap-6">
        {/* Left — logo */}
        <div className="w-12 h-12 rounded-[8px] bg-[rgba(49,141,217,0.2)] shrink-0" aria-label="Logo" />

        {/* Centre — links + copyright */}
        <div className="flex flex-col items-center gap-4">
          <div className="flex items-center gap-8">
            <a href="#" className="text-[#252525] text-[16px] font-medium tracking-[-0.48px] hover:text-[#0072d0] transition-colors">Home</a>
            <a href="#work" className="text-[#252525] text-[16px] font-medium tracking-[-0.48px] hover:text-[#0072d0] transition-colors">Work</a>
            <a href="#" className="text-[#252525] text-[16px] font-medium tracking-[-0.48px] hover:text-[#0072d0] transition-colors">Resume</a>
            <a href="#contact" className="text-[#252525] text-[16px] font-medium tracking-[-0.48px] hover:text-[#0072d0] transition-colors">Contact</a>
          </div>
          <p className="text-[#666] text-[14px] tracking-[-0.42px]">
            &copy; {new Date().getFullYear()} Joe Gentleman. All rights reserved.
          </p>
        </div>
